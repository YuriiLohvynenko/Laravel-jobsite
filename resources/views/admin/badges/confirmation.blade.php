        ...
        <div class="popup-tab-content" id="tab">
            ...
            <div class="padding-bottom-0">
                ...
                <div class="row margin-top-40">
                    <div class="col-6">
                        <a href="javascript:;" id="" class="popup-with-zoom-anim button gray ripple-effect"  onclick="openModal('{{$badge->user->id}}', '{{ $badge->id }}', 'small-dialog-1');return false;">Cancel</a>
                    </div>
