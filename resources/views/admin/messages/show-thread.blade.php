<div class="popup-tab-content" id="tab">
    ...
    <div class="padding-bottom-0">
        ...
        <div class="row">
            <div class="col-12">
                <div class="modal-main">User Messages</div>
                <div class="modal-description">From here you can remove messages and contact users</div>
            </div>
        </div>
...
<script>
    function disableChat(id){
        var url = "{{ route('admin.messages.changeStatus', [':status', ':id']) }}";
