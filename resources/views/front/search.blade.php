...
<head>
    ...
    /* Adding by Daniel Ramos */
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    /* Adding ended by Daniel Ramos */
    ...
    <div class="full-page-container with-map">
        ...
        <div class="full-page-sidebar hidden-sidebar enabled-sidebar">
            <div class="full-page-sidebar-inner" data-simplebar>
                ...
                <div class="sidebar-container">
                    <!-- Location -->
                    <div class="sidebar-widget location-row">
                        <div class="row find_title">
                            <div class="col-6">
                                <h3 style="line-height: 49px;">Find</h3>
                            </div>
                        ...
                        <span style="font-size: 12px; color: grey;">Location</span>

                        <div class="row location-select-row">
                            <div class="col-10 padding-left-0">
                                <input id="location" name="location" type="text" value="Maple Heights, Ohio" />
                            </div>
                    ...
                    <!-- Main Filter Lists -->
                    <div class="main-filter-widget-lists hidden-filter-lists enabled-filter-lists">
                ...
                <!-- Search Button -->
                <div class="sidebar-search-button-container hidden-search-filter enabled-search-filter">
		...
		<!-- Adding by Daniel Ramos -->
                ...
                <!-- <div class="sidebar-widget search-result-wrapper">
                    <div class="row">
                        <div class="col-12">
                            <div class="col-6 padding-left-0 search-input-section">
                                <span class="fa fa-search form-control-feedback" style="padding-left: 20px;"></span>
                                <span>&nbsp;&nbsp;Search...</span>
                            </div>
                            <div class="col-6 padding-right-0 search-result-section">
                                <span class="search_results_num">0</span>
                                <span class="search_results_text">Results</span>
                                <img src="{{ asset('/images/customize/horizontal_slider_icon.png') }}" class="horizontal_slider_icon" alt="Horizontal Slider Icon" /> 
                            </div>
                ...
                <!-- <img src="{{ asset('/images/customize/no_result.png') }}" alt="No Results" class="no_result_img" /> -->
