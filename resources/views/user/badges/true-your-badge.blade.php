        ...
        <div class="popup-tab-content" id="tab">
            ...
            <div class="padding-bottom-0">
                <div class="row margin-bottom-20">
                    <div class="col-12">
                        <div class="modal-main">True You Badge</div>
                    </div>
                    <div class="col-12">
                        <div class="modal-head-">When applying for this badge you will be prompted to provide a clear selfie with your ID in the foreground</div>
                    </div>
                </div>
                <form id="trueBadges" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <span class="universal-images trueyouimg"><img src="images/m42u0tk4ci.jpg" alt="" id="blah"></span>
                        </div>
                    </div>
