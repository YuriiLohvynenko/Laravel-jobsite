                            ...
                            @if($chat->image)
                                ...
                                @forelse($images as $img)
                                    <div class="imguploads ">
                                        <img src="{{ asset('../storage/app/public/dispute-files/'.$img) }}" alt="error">
                                    </div>
                                @empty
                                @endforelse
                            @endif
        ...
        <div class="margin-top-10">
            <form name="disputeDetailForm" id="disputeDetailForm">
                ...
                <div class="row margin-top-15 buttonsqa">
                    ...
                    <div class="col-4">
                        <a href="" id="javascript:;" onclick="submitDispute('{!! $timer !!}'); return false;" class="button gray ripple-effect modal-default-button" title="Once escalated final decision to be left to our team" data-tippy-placement="top">Dispute <i class="icon-feather-info modal-icon"></i></a>
                    </div>
                    <div class="col-4">
...
<script>
	function submitDispute(time){
		// console.log(time);
		if(time == '00h 00m'){
			console.log('enabled');
			var url = "{{ route('listing.dispute-mail') }}";
        $.easyAjax({
            url: url,
            type: "POST",
