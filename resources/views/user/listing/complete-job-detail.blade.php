<div class="popup-tab-content" id="tab">
    ...
    <div class="padding-bottom-0">
        ...
        <div class="row margin-top-20">
            <div class="col-6">
                <div class="modal-head">Completion Date</div>
                <div class="modal-head-">{{ $completionDate->date_time->format('d.m.Y') }}</div>
            </div>
            <div class="col-6">
        ...
        <div class="row margin-top-20">
            <div class="col-12">
                <div class="modal-note">Budget Increase: ${{ $totalBudgetIncrease }} <i class="icon-feather-info" title="Amount increased during task" data-tippy-placement="top"></i></div>
            </div>
        </div>
                        ...
                        <div class="margin-top-10">
                            ...
                            @forelse($jobDetail->budgetDetails as $budgetDetail)
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <div class="modal-sub-">@if(!is_null($budgetDetail->shift) && $budgetDetail->shift->start_date != null)  {{ $budgetDetail->shift->start_date->format('H:i a') }} @else -- @endif</div>
                                    </div>
                                    <div class="col-2">
                                        <div class="modal-sub-">@if(!is_null($budgetDetail->shift) && $budgetDetail->shift->end_date != null)  {{ $budgetDetail->shift->end_date->format('H:i a') }} @else -- @endif</div>
                                    </div>
                                </div>
                            @empty
                            @endforelse
